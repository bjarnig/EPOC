...
BGenNitrate : BGen
{
	...
	*loadSynthDefs {
		...
		SynthDef(\nitrateVerb,{| 	d1 = 0.2, d2 = 0.2, t1 = 2, t2 = 4, f1 = 500, f2 = 2000,
		in = 3, out = 0, amp=0.8, delayMult=1.0, decayMult=1.0, filtMult=1.0, mix=0.5|
	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	
	 	 		var inB, c1, c2, comb, verb, signal, highs;
		var roomsize=50, revtime=3.85, damping=0.11, inputbw=0.19, spread = 15, drylevel=(-6), earlylevel=(-9), taillevel=(-11);
	...
	setDescription {
		description = "BGenNitrate: SineReading granulator.";
	}
}