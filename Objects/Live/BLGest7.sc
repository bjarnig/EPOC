...
{ 	
	...
	*new { |id=0, description, duration=10, control, outBus=0, values, sound, buf,load=1|
	...
	initEffect {
		...
		reverb = Bwrap.new(\bLGest7Verb, [\inBus, effectBus, \outBus, outBus]);
		reverb.play;
	}
	
	*loadSynthDefs {
		
		SynthDef(\bLGest7, { |outBus=0, startPos=0.0, density=0.5, bufnum, rate=1.0, randSpeed=4, entropy=0.5, speed=0.1, bpFreq=400, atk=0.8, sus=12, rel=0.5,
		...
		SynthDef(\bLGest7Verb, {| outBus = 0, inBus=2, amp=1, dryWet=0.01, roomsize=140, revtime=4.85, damping=0.21, inputbw=0.19, 
