...
{ 	
	...
	*loadSynthDefs {
	 	...
	 	SynthDef(\bLSynth4,
		{| out=0, freq1=80, freq2=90, freq3=100, speed=80, amp=0.5, atk=0.5, sus=1, rel=0.1, surface=0.0, color=0.5, entropy=0.0, entropyFreq=1, filter=1000, density=0.5, pan=0.0, envSpeed=1.0,
		durations=#[0.5, 1, 0.75, 2, 4, 0.75, 1], amplitudes=#[0.1, 1.0, 0.4, 0.8, 1.0, 0.3, 0.9, 0.0]|
