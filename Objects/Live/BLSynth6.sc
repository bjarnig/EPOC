...
BLSynth6 : BGen
{
	...
	*new { |id=0, description, duration=10, control, outBus=0, values, durations, amplitudes, osc=0, curveType=0, load=1|
	...
	initEffect {
		...
		reverb = Bwrap.new(\bLSynth6Verb, [\inBus, effectBus, \outBus, outBus]);
		reverb.play;
	}

	*loadSynthDefs {

		SynthDef(\bLSynth6, {arg  outBus=0, amp=0.5, atk=0.5, sus=10, rel=0.1, freq=1000, pan=0.8, entropy=0.5, entropySpeed=0.5,
